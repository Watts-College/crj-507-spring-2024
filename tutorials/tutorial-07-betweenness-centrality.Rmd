...
*This tutorial examines betweenness centrality and centralization using the `betweenness()` and `centralization()` functions in the `sna` package.*
...
In this plot, we see that **Tom** and *Bob* both have scores of 3 and 4, respectively, whereas *Jen*, *Leaf*, and *Jim* have scores of 0. 
...
Much better. Now we can examine the centralization score for the network:
