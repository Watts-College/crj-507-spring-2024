...
The purpose of this lab is to familiarize yourself with bipartite graphs and two-mode networks in *R*. Please review the [Bipartite Graphs/Two-Mode Networks](https://jacobtnyoung.github.io/sna-textbook/ch-10-bipartite-graphs.html) chapter of the [SNA Textbook](https://jacobtnyoung.github.io/sna-textbook/index.html) as well as the [Bipartite Graphs and Two-Mode Networks in R]() tutorial prior to beginning this lab.
