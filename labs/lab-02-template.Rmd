...
Recall the instructions for Part I. For *each* network you created, do the following:  
...
Now, let's create the network object using the `network()` function.

```{r create-undirected-network, echo = TRUE, eval = TRUE}
...
```{r create-directed-network, echo = TRUE, eval = TRUE}
...
# produce the plot
gplot(
  net.u,                          # this is the network to plot
...
# produce the plot
gplot(
  net.d,                          # this is the network to plot
